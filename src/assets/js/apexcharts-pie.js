...
var options = {
    ...
    chart: {
        height: 400, // Increase the height to provide more space for labels
        width: 400,  // Increase the width to provide more space for labels
        type: 'pie',
    },
    ...
    dataLabels: {
        ...
        minAngleToShowLabel: 5, // Adjust this value based on your preference
    },
};
